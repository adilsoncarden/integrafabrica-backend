package com.integrafabrica.backend.module.movementdetail.controller;
...
public class MovementDetailAdminController {
    ...
    @GetMapping("")
    public ResponseEntity<Page<MovementDetailResponseDTO>> getAllDetails(
            @PageableDefault(size = 10, sort = "id", direction = Sort.Direction.ASC) Pageable pageable) {
        return ResponseEntity.ok(movementDetailService.getAllDetails(pageable));
    }
